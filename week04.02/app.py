...
def blog_list_func():
    datasets = [
        {"title": "탑", "content": "탑은 팀운 망겜이다."},
        {"title": "정글", "content": "정글은 모든 라인에게 구박받는 슬픈 라인이다."},
        {"title": "미드", "content": "미드가 잘하면 게임을 쉽게 풀어갈 수 있다."},
        {"title": "원딜", "content": "원딜은 계란이다."},
        {"title": "서폿", "content": "서폿은 그저 도구일 뿐이다."}
    ]
